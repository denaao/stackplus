...
// ─── ROTAS ESTÁTICAS (precisam vir ANTES de /:comandaId pra Express não capturar 'bank'/'cashbox'/etc) ───
...
// ─── ROTAS DINÂMICAS POR COMANDA (só depois das estáticas) ───
